(function () {
    ...
    function VendaService($http) {
        ...
        function findAllOver() {
            return $http.get('http://localhost:8080/api/vendas/all?order=nome')
        ...
        function findById(id) {
            return $http.get('http://localhost:8080/api/vendas/' + id)
                .then(function (response) {
                    return response.data;
                });
        }
        ...
        function remove(id) {
            return $http.delete('http://localhost:8080/api/vendas/' + id)
                .then(function (response) {
                    return response.data;
                });
        }
        ...
        function update(registro) {
            return $http.put('http://localhost:8080/api/vendas/' + registro.id, registro)
                .then(function (response) {
                    return response.data;
                });
        }
        ...
        function insert(registro) {
            return $http.post('http://localhost:8080/api/vendas', registro)
                .then(function (response) {
                    return response.data;
                });
        }
