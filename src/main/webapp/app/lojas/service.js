(function () {
    ...
    function LojaService($http) {
        ...
        function findAllOver() {
            return $http.get('http://localhost:8080/api/lojas/all?order=nome')
        ...
        function findById(id) {
            return $http.get('http://localhost:8080/api/lojas/' + id)
                .then(function (response) {
                    return response.data;
                });
        }
        ...
        function remove(id) {
            return $http.delete('http://localhost:8080/api/lojas/' + id)
                .then(function (response) {
                    return response.data;
                });
        }
        ...
        function update(registro) {
            return $http.put('http://localhost:8080/api/lojas/' + registro.id, registro)
                .then(function (response) {
                    return response.data;
                });
        }
        ...
        function insert(registro) {
            return $http.post('http://localhost:8080/api/lojas', registro)
                .then(function (response) {
                    return response.data;
                });
        }
